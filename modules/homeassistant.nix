...

{
  virtualisation.oci-containers.containers = {
    ...
    homeassistant = {
      image = "ghcr.io/home-assistant/home-assistant:stable@sha256:7fbf6a5e006e889d7799476ad7646bd18e9dc73e8a4ccd9326b41798de6bb3bf";
      autoStart = true;
      volumes = [
    ...
    otbr = {
      image = "openthread/otbr:latest@sha256:70f85c0c98f4ab716b57e1b1b7e5c3d1569b69c89d98bb8556499b9ee708082d";
      autoStart = true;
      cmd = [
