...

{
  virtualisation.oci-containers.containers = {
    ...
    homeassistant = {
      image = "ghcr.io/home-assistant/home-assistant:stable@sha256:6937c6c51d2f5d6aa66d97e4a68f845bcccd5f9b62cd91992bd6d79b20fe2b3c";
      autoStart = true;
      volumes = [
    ...
    otbr = {
      ...
      image = "docker.io/openthread/otbr:latest@sha256:937567231dcae5e9b4bcff82e3ee61ecb09295e91a73445d77e7e5e9ac92b72d";
      autoStart = true;
      cmd = [
