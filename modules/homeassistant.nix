...

{
  virtualisation.oci-containers.containers = {
    ...
    homeassistant = {
      image = "ghcr.io/home-assistant/home-assistant:stable@sha256:ff875078181a0383bf3fca9f061be12d6180896dbd531de04e094e25505b0bb9";
      autoStart = true;
      volumes = [
    ...
    otbr = {
      image = "openthread/otbr:latest@sha256:cb6618bbfb31a2b7d926cc92c968cd9e864dc60b9b0a4a0a6572a407f21649b3";
      autoStart = true;
      cmd = [
