...

{
  virtualisation.oci-containers.containers = {
    ...
    homeassistant = {
      image = "ghcr.io/home-assistant/home-assistant:stable@sha256:4c940155cfd5b0187a6faee2db5d52b98bb573edc1aeee95d0818bb17b6534d7";
      autoStart = true;
      volumes = [
    ...
    otbr = {
      image = "openthread/otbr:latest@sha256:1f8b74e1e65cfa2072278bb2c24e2c38dc02a774d7b1f76b5b7489ebed56c816";
      autoStart = true;
      cmd = [
