...

{
  ...
  virtualisation.oci-containers.containers = {
    piped-postgres = {
      image = "docker.io/postgres:16-alpine@sha256:16bc17c64a573ef34162af9298258d1aec548232985b33ed7b1eac33ba35c229";
      autoStart = true;
      environment = {
        POSTGRES_DB = "piped";
        POSTGRES_USER = "piped";
    ...
    piped-frontend = {
      image = "1337kavin/piped-frontend:latest@sha256:cd099e0a7b47dd473631bc600ca8b8e9faf3c21c834decb85b94d286e55eae48";
      autoStart = true;
    ...
    piped-proxy = {
      image = "1337kavin/piped-proxy:latest@sha256:09b348b654c1dc5fb710c55cb8d224b879763dac2642cd41f660bad42d034165";
      autoStart = true;
      extraOptions = [ "--network=piped" ];
      ports = [ "8182:8080" ];
    };
