...

{
  ...
  virtualisation.oci-containers.containers = {
    piped-postgres = {
      image = "docker.io/postgres:16-alpine@sha256:e013e867e712fec275706a6c51c966f0bb0c93cfa8f51000f85a15f9865a28cb";
      autoStart = true;
      environment = {
        POSTGRES_DB = "piped";
        POSTGRES_USER = "piped";
    ...
    piped-proxy = {
      image = "1337kavin/piped-proxy:latest@sha256:65390c4db40dd95a579c343a78032b66e3aadcd0aa738eb346278f8bfe03cab6";
      autoStart = true;
      extraOptions = [ "--network=piped" ];
      ports = [ "8182:8080" ];
    };
