...

{
  ...
  virtualisation.oci-containers.containers = {
    ...
    piped-frontend = {
      image = "1337kavin/piped-frontend:latest@sha256:4467c7fa568a9289e5352c0565d157b92f8141d245c3303550d53973623bbc4d";
      autoStart = true;
    ...
    piped-proxy = {
      image = "1337kavin/piped-proxy:latest@sha256:6f538f7b5d354c3ab9f11329a2ff1283249e388def53cef04dfa45b2fbce298c";
      autoStart = true;
      extraOptions = [ "--network=piped" ];
      ports = [ "8182:8080" ];
    };
