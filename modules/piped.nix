...

{
  ...
  virtualisation.oci-containers.containers = {
    piped-postgres = {
      image = "docker.io/postgres:16-alpine@sha256:5c4a21411ae06f964015aa9b5447b75f686dcded73d231289b75459d7c0b490a";
      autoStart = true;
      environment = {
        POSTGRES_DB = "piped";
        POSTGRES_USER = "piped";
    ...
    piped-proxy = {
      image = "1337kavin/piped-proxy:latest@sha256:1e59e9379a2b272fea79e424e681873fbd644555ab06aaedfac1e8f63d316d2a";
      autoStart = true;
      extraOptions = [ "--network=piped" ];
      ports = [ "8182:8080" ];
    };
