...

{
  ...
  virtualisation.oci-containers.containers = {
    ...
    piped-frontend = {
      image = "1337kavin/piped-frontend:latest@sha256:c6b148b35d98f8978d1eb80f00f75c8b5a2f201f7301dae3c0377a62a0838398";
      autoStart = true;
    ...
    piped-proxy = {
      image = "1337kavin/piped-proxy:latest@sha256:a83b064fe04b18f263849dd38c77dfcf135c1999a106b99eff5f6a188357ea74";
      autoStart = true;
      extraOptions = [ "--network=piped" ];
      ports = [ "8182:8080" ];
    };
