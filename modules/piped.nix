...

{
  ...
  virtualisation.oci-containers.containers = {
    ...
    piped-frontend = {
      image = "1337kavin/piped-frontend:latest@sha256:e811716f414b421f222994fbaecb0f6733b6d10b2cb6be8f1db3d0f208980570";
      autoStart = true;
    ...
    piped-proxy = {
      image = "1337kavin/piped-proxy:latest@sha256:ed114f970d5cda985fc2d4880ad09f7bac7d14dcfb5a6654d1e36712a6b1688b";
      autoStart = true;
      extraOptions = [ "--network=piped" ];
      ports = [ "8182:8080" ];
    };
