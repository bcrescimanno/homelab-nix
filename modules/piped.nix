...

{
  ...
  virtualisation.oci-containers.containers = {
    ...
    piped-frontend = {
      image = "1337kavin/piped-frontend:latest@sha256:2c9d0ba4dc3e6dbca5252d03ea30aa230df8341fc316a51a97d7ead142996957";
      autoStart = true;
    ...
    piped-proxy = {
      image = "1337kavin/piped-proxy:latest@sha256:09977ec6246af17ca6eb0c194344d43db760b8466224162da32d4299e292fd7c";
      autoStart = true;
      extraOptions = [ "--network=piped" ];
      ports = [ "8182:8080" ];
    };
