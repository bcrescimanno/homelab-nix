...

{
  ...
  virtualisation.oci-containers.containers = {
    piped-postgres = {
      image = "docker.io/postgres:16-alpine@sha256:e53683f43dd931aeacaef349422caf1f6259389ca5eab0c11763fcb8d38f26af";
      autoStart = true;
      environment = {
        POSTGRES_DB = "piped";
        POSTGRES_USER = "piped";
    ...
    piped-proxy = {
      image = "1337kavin/piped-proxy:latest@sha256:b15b3dfbd262c438c5923d7dc3a0059af84051856802e43542eafcc8d6de5143";
      autoStart = true;
      extraOptions = [ "--network=piped" ];
      ports = [ "8182:8080" ];
    };
