...

{
  ...
  virtualisation.oci-containers.containers = {
    piped-postgres = {
      image = "docker.io/postgres:16-alpine@sha256:fd1e8d0274f13f5a03a2673a207b28e14823c2f2efc3ca4bb4197c8a9f841bdc";
      autoStart = true;
      environment = {
        POSTGRES_DB = "piped";
        POSTGRES_USER = "piped";
    ...
    piped-proxy = {
      image = "1337kavin/piped-proxy:latest@sha256:be43f8d1c4b623c344c52c78a446bce6b1d08b0176dffebaa7bb8d9897a6cc3f";
      autoStart = true;
      extraOptions = [ "--network=piped" ];
      ports = [ "8182:8080" ];
    };
