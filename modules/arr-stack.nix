...

{
  virtualisation.oci-containers.containers = {
    ...
    gluetun = {
      image = "ghcr.io/qdm12/gluetun:latest@sha256:c7b6a58e1c7ba9c6cc970ae84fa7075efd8df00ca393079f9b097c42aea36973";
      autoStart = true;
      volumes = [
    ...
    radarr = {
      image = "lscr.io/linuxserver/radarr:latest@sha256:581f159c2b67436863cb4da30e158ef6f6b8878472abbba79ee5d5f7e6b7d28d";
      autoStart = true;
      dependsOn = [ "gluetun" ];
      extraOptions = [ "--network=container:gluetun" ];
      environment = {
