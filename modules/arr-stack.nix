...

{
  virtualisation.oci-containers.containers = {
    ...
    gluetun = {
      image = "ghcr.io/qdm12/gluetun:latest@sha256:988d9cb1982f688ce51f3511057b90c5c8d01889db60a4d56e5230aebf1d3339";
      autoStart = true;
      volumes = [
    ...
    lidarr = {
      image = "lscr.io/linuxserver/lidarr:latest@sha256:60be9a1faad3dfba5a711163fc18526845e2ce7b50b463dd9effae7f766c9beb";
      autoStart = true;
      dependsOn = [ "gluetun" ];
      extraOptions = [ "--network=container:gluetun" ];
      environment = {
    ...
    sabnzbd = {
      image = "lscr.io/linuxserver/sabnzbd:latest@sha256:302be8972d4627222a0701634f2f9025826d760d856414aa6e67c0a66833e5be";
      autoStart = true;
      dependsOn = [ "gluetun" ];
      extraOptions = [ "--network=container:gluetun" ];
      environment = {
