...

{
  virtualisation.oci-containers.containers = {
    ...
    gluetun = {
      image = "ghcr.io/qdm12/gluetun:latest@sha256:fcbe2e4919b05dd9653a6ce64304bd4f532d5b52e1356aaec4430713fa53c839";
      autoStart = true;
      volumes = [
    ...
    qbittorrent = {
      image = "lscr.io/linuxserver/qbittorrent:libtorrentv1@sha256:4f6b28739ae2279559fdc07fd03809f99760481e332f2d93ee556201aa0ad433";
      autoStart = true;
      dependsOn = [ "gluetun" ];
    ...
    jellyfin = {
      image = "ghcr.io/linuxserver/jellyfin:latest@sha256:5c7691c30033c7e880c253090735c4839cc032fcd51f3a794d5689d2c5637046";
      autoStart = true;
      environment = {
        PUID = "1000";
        PGID = "1000";
