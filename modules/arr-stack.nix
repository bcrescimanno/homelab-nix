...

{
  virtualisation.oci-containers.containers = {
    ...
    gluetun = {
      image = "ghcr.io/qdm12/gluetun:latest@sha256:dce820e5e35e1025012edd00719d8e6ab9c7bc10a1fc23a7d3d45875f2e82f19";
      autoStart = true;
      volumes = [
    ...
    prowlarr = {
      image = "lscr.io/linuxserver/prowlarr:latest@sha256:f2b26429893d4c4cb71941b7ee50b1bdecd9d5f9f9e02d5410615e9f4f7c8d95";
      autoStart = true;
      dependsOn = [ "gluetun" ];
      extraOptions = [ "--network=container:gluetun" ];
      environment = {
