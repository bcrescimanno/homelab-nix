...

{
  virtualisation.oci-containers.containers = {
    ...
    gluetun = {
      image = "ghcr.io/qdm12/gluetun:latest@sha256:20ca3a534cd7c5733f76bee2ef118847cc9e98a8e397234644af2fcbf7be0725";
      autoStart = true;
      volumes = [
    ...
    qbittorrent = {
      image = "lscr.io/linuxserver/qbittorrent:libtorrentv1@sha256:1dab6592cf26292c84d560d86a89154e7a1f1df86055d9a4af967ebc1eddbe63";
      autoStart = true;
      dependsOn = [ "gluetun" ];
    ...
    prowlarr = {
      image = "lscr.io/linuxserver/prowlarr:latest@sha256:c7502a75b021d964481c129c84590b9cbc40f83aadd4e553f173871bc0deaa3c";
      autoStart = true;
      dependsOn = [ "gluetun" ];
      extraOptions = [ "--network=container:gluetun" ];
      environment = {
    ...
    lidarr = {
      image = "lscr.io/linuxserver/lidarr:latest@sha256:8ab0fd370b604ae034d9a9c261a9d8d873bece33d9736852e7ce4f3566e4a35d";
      autoStart = true;
      dependsOn = [ "gluetun" ];
      extraOptions = [ "--network=container:gluetun" ];
      environment = {
    ...
    sabnzbd = {
      image = "lscr.io/linuxserver/sabnzbd:latest@sha256:7f173ced3541b46c57c4eb6854765243095c8c8a7563a878044fa0ccfb1f4004";
      autoStart = true;
      dependsOn = [ "gluetun" ];
      extraOptions = [ "--network=container:gluetun" ];
      environment = {
